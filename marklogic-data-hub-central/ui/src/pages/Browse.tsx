...
const Browse: React.FC<Props> = ({location}) => {
  ...
  const [graphView, setGraphView] = useState(location && location.state && location.state["isEntityInstance"] ? true : JSON.parse(getUserPreferences(user.name)).graphView ? true : false);
                    ...
                    <div className={styles.spinViews}>
                      <div style={switchViewsGraphStyle()}>
                        ...
                        {!cardView ? <div id="switch-view-explorer" aria-label="switch-view" >
                          ...
                          >
                            <Radio.Button aria-label="switch-view-graph" value={"graph"}>
